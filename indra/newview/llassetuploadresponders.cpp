...
{
	LL_INFOS() << "LLAssetUploadResponder::error " << statusNum 
...
{
	lldebugs << "LLAssetUploadResponder::result from capabilities" << LL_ENDL;
...
{
	lldebugs << "LLNewAgentInventoryResponder::result from capabilities" << LL_ENDL;
	...
	if(mPostData["folder_id"].asUUID().notNull())
	{
		...
		//LL_INFOS() << "Post Data: " << out.str() << LL_ENDL;
...
{
	LL_INFOS() << "status: " << statusNum << " reason: " << reason << LL_ENDL;
